//! Windissect-generated Rust FFI bindings for Microsoft.UI.Composition.OSSupport.dll. Windows only.
#![allow(non_snake_case, non_camel_case_types, dead_code)]

pub mod handles;
pub mod vtables;

pub const EXPECTED_PDB_GUID: &str = "7DAE910C92E7B693BE6715ACFED01342";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3646022487;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 39] = [77, 105, 99, 114, 111, 115, 111, 102, 116, 46, 85, 73, 46, 67, 111, 109, 112, 111, 115, 105, 116, 105, 111, 110, 46, 79, 83, 83, 117, 112, 112, 111, 114, 116, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3646022487 { return 0; }
